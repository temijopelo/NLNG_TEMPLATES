def review_adp_email(customer_name, year_number,review_adp_link):
          ...
          <tr style="width:100%">
            <td>
              ...
              <div style="background-color:#e8f0f0;padding:0px 56px 32px 40px">
                <div
                  style="background-color:#FFFFFF;border:1px solid #2563EB;border-radius:0;padding:16px 24px 24px 24px"
                >
                  <div
                ...
                <div
                  style="font-size:10px;font-weight:normal;text-align:center;padding:16px 24px 16px 20px"
                >
