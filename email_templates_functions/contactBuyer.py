def contact_buyer_email(cargo_id, days_remaining,contact_buyer_link):
            ...
            <td>
              ...
              <div style="background-color:#e8f0f0;padding:0px 56px 32px 40px">
                ...
                >
                  ...
                  >
                    FOB Vessel Nomination Reminder
                  </div>
                  <div
                    style="font-size:12px;font-weight:normal;padding:16px 24px 16px 24px"
                  >
                    This is a reminder that there are {days_remaining} days to the estimated
                    start of loading for cargo: {cargo_id}, Kindly
                    contact the buyer to nominate a vessel for this FOB cargo
                    delivery
                  </div>
                  <div style="text-align:center;padding:16px 24px 16px 24px">
                    <a
                      href="{contact_buyer_link}"
...
# cargo_email_html = generate_fob_email("ABC12345", 20)
# print(cargo_email_html)